...
*/
class UnlockRequest extends StringRequest {

    private static final String UNLOCK_REQUEST_URL =
            "http://rat-tracker.000webhostapp.com/Unlock.php";
     ...
     */
    public UnlockRequest(String username, Response.Listener<String> listener) {
        super(Request.Method.POST, UNLOCK_REQUEST_URL, listener, null);
        params = new HashMap<>();
